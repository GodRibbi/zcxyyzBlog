...
function() {
    ...
    n = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], i = n.length, r = window.console = window.console || {}; i--;) t = n[i],
    r[t] || (r[t] = e)
} (),
$(function() {
    $(".browsehappy").on("click",
    function() {
        $(this).slideUp("fast")
    })
}),
function(t, e) {
    ...
    i.throttle = n = function(t, n, r, o) {
        function s() {
            ...
            o && !a && i(),
            a && clearTimeout(a),
            o === e && c > t ? i() : n !== !0 && (a = setTimeout(o ? s: i, o === e ? t - c: t))
        }
        var a, u = 0;
        return "boolean" != typeof n && (o = r, r = n, n = e),
...
function(t) {
    ...
    c = function(t, i) {
        ...
        n = 0;
        for (var g = 0,
        m = a.length; m > g; g++)"zIndex" in a[g] && (l.push(a[g].zIndex), a[g].zIndex < 0 && (f[a[g].zIndex] = a[g]));
        for (l.sort(u); l[h] < 0;) if (r = f[l[h++]], p.push(r.apply(i, s)), n) return n = o,
        p;
        for (g = 0; m > g; g++) if (r = a[g], "zIndex" in r) if (r.zIndex == l[h]) {
            if (p.push(r.apply(i, s)), n) break;
            do
            if (h++, r = f[l[h]], r && p.push(r.apply(i, s)), n) break;
            while (r)
        } else f[r.zIndex] = r;
    ...
    c.listeners = function(t) {
        ...
        for (r = 0, a = f.length; a > r; r++) {
            for (l = [], u = 0, c = d.length; c > u; u++) for (p = d[u].n, n = [p[f[r]], p[s]], i = 2; i--;) e = n[i],
            e && (l.push(e), g = g.concat(e.f || []));
            d = l
        }
        return g
    },
    c.on = function(t, e) {
        ...
        for (var n = t.split(o), i = h, r = 0, s = n.length; s > r; r++) i = i.n,
        i = i.hasOwnProperty(n[r]) && i[n[r]] || (i[n[r]] = {
            n: {}
        });
    ...
    c.off = c.unbind = function(t, e) {
        ...
        for (u = 0, l = d.length; l > u; u++) for (f = 0; f < g.length; f += a.length - 2) {
            ...
            else for (i in n) n[r](i) && a.push(n[i]);
            g.splice.apply(g, a)
        }
    ...
    "undefined" != typeof module && module.exports ? module.exports = c: "undefined" != typeof define ? define("eve", [],
    function() {
        return c
    }) : t.eve = c
} (this),
...
function(t, e) {
    var n = function(e) {
        ...
        g = function() {
            ...
            for (var o in n) if (n.hasOwnProperty(o)) {
                var s, a = n[o],
                u = a.get();
                if (t++, a.s = (u - a.b) / (a.dur / a.spd), a.s >= 1 && (delete n[o], a.s = 1, t--,
                function(t) {
                    setTimeout(function() {
                    ...
                    s = [];
                    for (var h = 0,
                    c = a.start.length; c > h; h++) s[h] = +a.start[h] + (a.end[h] - a.start[h]) * a.easing(a.s)
        ...
        m.bounce = function(t) {
            var e, n = 7.5625,
            i = 2.75;
            return 1 / i > t ? e = n * t * t: 2 / i > t ? (t -= 1.5 / i, e = n * t * t + .75) : 2.5 / i > t ? (t -= 2.25 / i, e = n * t * t + .9375) : (t -= 2.625 / i, e = n * t * t + .984375),
            e
        },
        t.mina = m,
        m
    ...
    i = function() {
        function i(t, e) {
            if (t) {
                ...
                if (null == e) return t = A.doc.querySelector(t),
                k(t)
            }
        ...
        function o(t, e) {
            return e = j.prototype.toLowerCase.call(e),
            "finite" == e ? isFinite(t) : "array" == e && (t instanceof Array || Array.isArray && Array.isArray(t)) ? !0 : "null" == e && null === t || e == typeof t && null !== t || "object" == e && t === Object(t) || V.call(t).slice(8, -1).toLowerCase() == e
        }
        function s(t) {
        ...
        function a(t, e) {
            for (var n = 0,
            i = t.length; i > n; n++) if (t[n] === e) return t.push(t.splice(n, 1)[0])
        }
        function u(t, e, n) {
            function i() {
        ...
        function p(t) {
            ...
            function(t, n, i) {
                ...
                "scale" == n && (2 == i.length && i.push(0, 0), 1 == i.length && i.push(i[0], 0, 0)),
                "skewX" == n ? e.push(["m", 1, 0, N.tan(c(i[0])), 1, 0, 0]) : "skewY" == n ? e.push(["m", 1, N.tan(c(i[0])), 0, 1, 0, 0]) : e.push([n.charAt(0)].concat(i)),
                t
            }),
            e
        }
        ...
        function m(t, e) {
            if (null == e) {
                ...
                e = p(e)
            } else e = i._.rgTransform.test(e) ? j(e).replace(/\.{3}|\u2026/g, t._.transform || $) : p(e),
            o(e, "array") && (e = i.path ? i.path.toString.call(e) : j(e)),
            t._.transform = e;
        ...
        function x(t) {
            ...
            for (var e = 0,
            n = 0,
            i = this.node; this[e];) delete this[e++];
        ...
        function b(t) {
            ...
            t.snap = n, at[n] = this, "g" == this.type) {
                this.add = x;
        ...
        function w(t) {
            for (var e, n = 0,
            i = t.length; i > n; n++) if (e = e || t[n]) return e
        }
        function S(t) {
            this.node = t
        }
        ...
        function C(t, e) {
            ...
            if (t && "svg" == t.tagName) {
                ...
                i || (i = r("desc"), i.appendChild(A.doc.createTextNode("Created with Snap")), n.node.appendChild(i)),
                o || (o = r("defs"), n.node.appendChild(o)),
                n.defs = o;
                for (var a in s) s[M](a) && (n[a] = s[a]);
                n.paper = n.root = n
            } else n = E("svg", A.doc.body),
            r(n.node, {
                height: e,
                version: 1.1,
                width: t,
        ...
        function P(t, n) {
            ...
            if (!s) return null;
            s.params.unshift(t),
            o = "l" == s.type.toLowerCase() ? R.apply(0, s.params) : I.apply(0, s.params),
            s.type != s.type.toLowerCase() && r(o.node, {
        ...
        function z(t) {
            for (var e = [], n = t.childNodes, i = 0, r = n.length; r > i; i++) {
                ...
                "tspan" == o.tagName && (1 == o.childNodes.length && 3 == o.firstChild.nodeType ? e.push(o.firstChild.nodeValue) : e.push(z(o)))
            }
            return e
        }
        i.version = "0.2.0",
        ...
        et = new RegExp("(-?\\d*\\.?\\d*(?:e[\\-+]?\\d+)?)[" + Y + "]*,?[" + Y + "]*", "ig"),
        nt = 0,
        it = "S" + ( + new Date).toString(36),
        rt = function() {
        ...
        function(t) {
            ...
            t.rotate = function(t, e, n) {
                ...
                e = e || 0,
                n = n || 0;
                var i = +N.cos(t).toFixed(9),
                r = +N.sin(t).toFixed(9);
                return this.add(i, r, -r, i, e, n),
            ...
            t.split = function() {
                ...
                t.scalex = N.sqrt(e(i[0])),
                n(i[0]),
                t.shear = i[0][0] * i[1][0] + i[0][1] * i[1][1],
                i[1] = [i[1][0] - i[0][0] * t.shear, i[1][1] - i[0][1] * t.shear],
                t.scaley = N.sqrt(e(i[1])),
                n(i[1]),
                t.shear /= t.scaley;
                var r = -i[0][1],
                o = i[1][1];
                return 0 > o ? (t.rotate = l(N.acos(o)), 0 > r && (t.rotate = 360 - t.rotate)) : t.rotate = l(N.asin(r)),
        ...
        i.hsb2rgb = function(t, e, n, i) {
            o(t, "object") && "h" in t && "s" in t && "b" in t && (n = t.b, e = t.s, t = t.h, i = t.o),
            t *= 360;
            var r, s, a, u, h;
            return t = t % 360 / 60,
            h = n * e,
        ...
        i.rgb2hsl = function(t, e, n) {
            ...
            a = q(t, e, n),
            u = s - a,
            i = 0 == u ? null: s == t ? (e - n) / u: s == e ? (n - t) / u + 2 : (t - e) / u + 4,
            i = 60 * ((i + 360) % 6) / 360,
            o = (s + a) / 2,
            r = 0 == u ? 0 : .5 > o ? u / (2 * o) : u / (2 - 2 * o),
            {
                h: i,
                s: r,
                l: o,
        ...
        i.parsePathString = function(t) {
            ...
            r = [];
            return o(t, "array") && o(t[0], "array") && (r = i.path.clone(t)),
            r.length || j(t).replace(K,
            function(t, e, i) {
                var o = [],
                s = e.toLowerCase();
                if (i.replace(et,
                ...
                else for (; o.length >= n[s] && (r.push([e].concat(o.splice(0, n[s]))), n[s]););
            }),
        ...
        var mt = i.parseTransformString = function(t) {
            if (!t) return null;
            var e = [];
            return o(t, "array") && o(t[0], "array") && (e = i.path.clone(t)),
            e.length || j(t).replace(tt,
            function(t, n, i) {
                var r = [];
                n.toLowerCase(),
                i.replace(et,
        ...
        i._.svgTransform2string = p,
        i._.rgTransform = new RegExp("^[a-z][" + Y + "]*-?\\.?\\d", "i"),
        i._.transform2matrix = d,
        i._unit2px = v;
        var yt = A.doc.contains || A.doc.compareDocumentPosition ?
        function(t, e) {
        ...
        function(t) {
            function s(t) {
                function e(t, e) {
                    ...
                    n = n && n.match(s),
                    n = n && n[2],
                    n && "#" == n.charAt() && (n = n.substring(1), n && (u[n] = (u[n] || []).concat(function(n) {
                        var i = {};
                        i[e] = ut(n),
                        r(t.node, i)
                    })))
                ...
                for (var i, o = t.selectAll("*"), s = /^\s*url\(("|'|)(.*)\1\)\s*$/, a = [], u = {},
                h = 0, c = o.length; c > h; h++) {
                    i = o[h],
                    e(i, "fill"),
                    e(i, "stroke"),
                    e(i, "filter"),
            ...
            function u(t) {
                return function() {
                    ...
                    if (t) for (var r = 0,
                    o = n.length; o > r; r++) e += " " + n[r].name + '="' + n[r].value.replace(/"/g, '\\"') + '"';
                    if (i.length) {
            ...
            t.transform = function(t) {
                ...
                return t instanceof f && (t = t.toTransformString()),
                m(this, t),
                this.node && ("linearGradient" == this.type || "radialGradient" == this.type ? r(this.node, {
            ...
            t.use = function() {
                ...
                t = "linearGradient" == this.type || "radialGradient" == this.type || "pattern" == this.type ? E(this.type, this.node.parentNode) : E("use", this.node.parentNode),
                r(t.node, {
                    "xlink:href": "#" + e
                }),
                t.original = this,
            ...
            t.pattern = function(t, e, n, i) {
                ...
                o(t, "object") && "x" in t && (e = t.y, n = t.width, i = t.height, t = t.x),
                r(s.node, {
                    x: t,
                    y: e,
                    width: n,
            ...
            t.marker = function(t, e, n, i, s, a) {
                ...
                return null == t && (t = this.getBBox()),
                o(t, "object") && "x" in t && (e = t.y, n = t.width, i = t.height, s = t.refX || t.cx, a = t.refY || t.cy, t = t.x),
                r(u.node, {
            ...
            t.inAnim = function() {
                var t = this,
                e = [];
                for (var n in t.anims) t.anims[M](n) && !
                function(t) {
                    e.push({
            ...
            i.animate = function(t, i, r, o, s, a) {
                ...
                return a && e.once("mina.finish." + h.id, a),
                h
            },
            t.stop = function() {
            ...
            t.animate = function(t, i, r, s) {
                "function" != typeof r || r.length || (s = r, r = n.linear),
                t instanceof c && (s = t.callback, r = t.easing, i = r.dur, t = t.attr);
                var u, h, l, f, p = [],
                d = [],
                g = {},
                m = this;
                for (var y in t) if (t[M](y)) {
                    ...
                    g[y] = a(p.length, p.length + v, l),
                    p = p.concat(u),
                    d = d.concat(h)
                }
                var x = n.time(),
                b = n(p, d, x, x + i, n.time,
                function(t) {
                    var e = {};
                ...
                r);
                return m.anims[b.id] = b,
                b._attrs = t,
                b._callback = s,
                e.once("mina.finish." + b.id,
                function() {
                    delete m.anims[b.id],
                    s && s.call(m)
                }),
                e.once("mina.stop." + b.id,
                function() {
                    delete m.anims[b.id]
                }),
                m
            ...
            t.data = function(t, n) {
                ...
                if (1 == arguments.length) {
                    ...
                    return e("snap.data.get." + this.id, this, r[t], t),
                    r[t]
                }
                return r[t] = n,
            ...
            t.removeData = function(t) {
                return null == t ? l[this.id] = {}: l[this.id] && delete l[this.id][t],
                this
            },
        ...
        i.parse = function(t) {
            ...
            if (t = j(t), t.match(/^\s*<\s*svg(?:\s|>)/) || (t = "<svg>" + t + "</svg>", n = !1), i.innerHTML = t, t = i.getElementsByTagName("svg")[0]) if (n) e = t;
            else for (; t.firstChild;) e.appendChild(t.firstChild);
            return i.innerHTML = $,
            new S(e)
        },
        S.prototype.select = b.prototype.select,
        S.prototype.selectAll = b.prototype.selectAll,
        i.fragment = function() {
        ...
        function(t) {
            ...
            t.rect = function(t, e, n, i, r, s) {
                var a;
                return null == s && (s = r),
                o(t, "object") && "x" in t ? a = t: null != t && (a = {
                    x: t,
                    y: e,
                    width: n,
                    height: i
                },
                null != r && (a.rx = r, a.ry = s)),
                this.el("rect", a)
            },
            ...
            t.image = function(t, e, n, i, s) {
                ...
                if (o(t, "object") && "src" in t) a.attr(t);
                    ...
                    null != e && null != n && (u.x = e, u.y = n),
                    null != i && null != s ? (u.width = i, u.height = s) : ht(t,
                    function() {
                        r(a.node, {
            ...
            t.group = t.g = function(e) {
                ...
                return 1 == arguments.length && e && !e.type ? n.attr(e) : arguments.length && n.add(Array.prototype.slice.call(arguments, 0)),
                n
            },
        ...
        i.ajax = function(t, n, i, r) {
            ...
            if (s) {
                ...
                return s.open(n ? "POST": "GET", t, !0),
                s.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                n && s.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
        ...
        e.on("snap.util.attr.fill", B("fill")),
        e.on("snap.util.attr.stroke", B("stroke"));
        var vt = /^([lr])(?:\(([^)]*)\))?(.*)$/i;
        ...
        function(t) {
            e.stop(),
            o(t, "array") && o(t[0], "array") && (t = i.path.toString.call(t)),
            t = j(t),
            t.match(/[ruo]/i) && (t = i.path.toAbsolute(t)),
            r(this.node, {
                d: t
            })
        })( - 1),
        ...
        function(t) {
            var n;
            n = o(t, "object") && "x" in t ? [t.x, t.y, t.width, t.height].join(" ") : o(t, "array") ? t.join(" ") : t,
            r(this.node, {
                viewBox: n
            }),
            e.stop()
        ...
        function(t) {
            if (e.stop(), "text" == this.type) {
                ...
                if (o(t, "string")) {
                    ...
                    a.appendChild(u.node),
                    n = u.id,
                    u.attr({
                        id: n
                    })
                } else t = k(t),
                t instanceof b && (n = t.attr("id"), n || (n = t.id, t.attr({
                    id: n
                })));
                if (n) if (i = this.textPath, s = this.node, i) i.attr({
                    "xlink:href": "#" + n
                });
                else {
                    for (i = r("textPath", {
        ...
        function(t) {
            if ("text" == this.type) {
                ...
                i = function(t) {
                    var e = r("tspan");
                    if (o(t, "array")) for (var n = 0; n < t.length; n++) e.appendChild(i(t[n]));
    ...
    return i.plugin(function(t, e) {
        ...
        function a(n, i) {
            ...
            return t._.cacher(function(t, o, a) {
                    ...
                    c = +l[2];
                        ...
                        if (f = s(h, c, l[1], l[2], l[3], l[4], l[5], l[6]), m + f > o) {
                            if (i && !g.start) {
                                ...
                                g.start = d,
                                d = ["M" + r(p.x), r(p.y) + "C" + r(p.n.x), r(p.n.y), r(p.end.x), r(p.end.y), r(l[5]), r(l[6])].join(),
                                m += f,
                                h = +l[5],
                                c = +l[6];
                                continue
                ...
                return g.end = d,
                p = n ? m: i ? g: u(h, c, l[0], l[1], l[2], l[3], l[4], l[5], 1)
            },
            null, t._.clone)
        }
        ...
        function p(t, e, n, i, r, o, s, a, u) {
            ...
            for (var h = u / 2,
            c = 12,
            l = [ - .1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699, -.9041, .9041, -.9816, .9816], p = [.2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472], d = 0, g = 0; c > g; g++) {
                var m = h * l[g] + h,
                y = f(m, t, n, r, s),
                v = f(m, e, i, o, a),
                x = y * y + v * v;
        ...
        function d(t, e, n, i, r, o, s, a, u) {
            if (! (0 > u || p(t, e, n, i, r, o, s, a) < u)) {
                ...
                f = c - l,
                d = .01;
                for (h = p(t, e, n, i, r, o, s, a, f); G(h - u) > d;) l /= 2,
                f += (u > h ? 1 : -1) * l,
                h = p(t, e, n, i, r, o, s, a, f);
                return f
            }
        }
        ...
        function m(t, e, n) {
            ...
            r = h(e);
            if (!l(i, r)) return n ? 0 : [];
            for (var o = p.apply(0, t), s = p.apply(0, e), a = ~~ (o / 5), c = ~~ (s / 5), f = [], d = [], m = {},
            y = n ? 0 : [], v = 0; a + 1 > v; v++) {
            ...
            for (v = 0; c + 1 > v; v++) x = u.apply(0, e.concat(v / c)),
            d.push({
                x: x.x,
                y: x.y,
                t: v / c
                    ...
                    x = e.length; x > v; v++) {
                        ...
                        s = c = b[2];
                            ...
                            if (n) p += w;
                                ...
                                for (var S = 0,
                                E = w.length; E > S; S++) w[S].segment1 = d,
                                w[S].segment2 = v,
                                w[S].bez1 = l,
                                w[S].bez2 = f;
                                p = p.concat(w)
        ...
        function w(t) {
            ...
            for (var r, o = 0,
            s = 0,
            a = [], u = [], h = 0, c = t.length; c > h; h++) if (r = t[h], "M" == r[0]) o = r[1],
            s = r[2],
            a.push(o),
            u.push(s);
            else {
                var l = R(o, s, r[1], r[2], r[3], r[4], r[5], r[6]);
                a = a.concat(l.min.x, l.max.x),
                u = u.concat(l.min.y, l.max.y),
                o = r[5],
                s = r[6]
            }
            var f = W.apply(0, a),
        ...
        function E(t, e, n, i, o) {
            ...
            h = e + n * Math.sin( - i * s),
            c = e + n * Math.sin( - o * s),
            l = [["M", a, h], ["A", n, n, 0, +(o - i > 180), 0, u, c]];
            else l = [["M", t, e], ["m", 0, -i], ["a", n, i, 0, 1, 1, 0, 2 * i], ["a", n, i, 0, 1, 1, 0, -2 * i], ["z"]];
            return l.toString = r,
            l
        }
        function C(e) {
            ...
            d = e.length; d > p; p++) {
                ...
                default:
                    for (var y = 1,
                    v = m.length; v > y; y++) g[y] = +(m[y] - (y % 2 ? u: h)).toFixed(3)
                } else {
                    g = a[p] = [],
                    "m" == m[0] && (c = m[1] + u, l = m[2] + h);
                    for (var x = 0,
                    b = m.length; b > x; x++) a[p][x] = m[x]
                }
                var w = a[p].length;
                switch (a[p][0]) {
                case "z":
        ...
        function k(e) {
            ...
            for (var p, d, g = 3 == e.length && "M" == e[0][0] && "R" == e[1][0].toUpperCase() && "Z" == e[2][0].toUpperCase(), m = f, y = e.length; y > m; m++) {
                ...
                case "H":
                    ...
                    break;
                case "R":
                    for (var v = [u, h].concat(d.slice(1)), x = 2, b = v.length; b > x; x++) v[x] = +v[x] + u,
                    v[++x] = +v[x] + h;
                    a.pop(),
                    a = a.concat(z(v, g));
                    break;
                ...
                case "U":
                    a.pop(),
                    a = a.concat(E(u, h, d[1], d[2], d[3])),
                    p = ["U"].concat(a[a.length - 1].slice( - 2));
                    break;
                case "M":
                    c = +d[1] + u,
                    l = +d[2] + h;
                ...
                } else if ("R" == s) v = [u, h].concat(d.slice(1)),
                a.pop(),
                a = a.concat(z(v, g)),
        ...
        function L(e, n, i, r, o, s, a, u, h, c) {
            ...
            g = t._.cacher(function(t, e, n) {
                var i = t * F.cos(n) - e * F.sin(n),
                r = t * F.sin(n) + e * F.cos(n);
                return {
                    x: i,
                    y: r
                }
            ...
            E = c[3];
                ...
                u = l.x,
                h = l.y;
                var m = (F.cos(q / 180 * o), F.sin(q / 180 * o), (e - u) / 2),
                y = (n - h) / 2,
                v = m * m / (i * i) + y * y / (r * r);
                ...
                S = w * i * y / r + (e + u) / 2,
                E = w * -r * m / i + (n + h) / 2,
                C = F.asin(((n - E) / r).toFixed(9)),
                k = F.asin(((h - E) / r).toFixed(9));
                C = S > e ? q - C: C,
                k = S > u ? q - k: k,
                0 > C && (C = 2 * q + C),
                0 > k && (k = 2 * q + k),
        ...
        function R(t, e, n, i, r, o, s, a) {
            ...
            c = 2 * (n - t) - 2 * (r - n),
            l = t - n,
            f = ( - c + F.sqrt(c * c - 4 * h * l)) / 2 / h,
            p = ( - c - F.sqrt(c * c - 4 * h * l)) / 2 / h,
            d = [e, a],
            g = [t, s];
            return G(f) > "1e12" && (f = .5),
            G(p) > "1e12" && (p = .5),
            f > 0 && 1 > f && (u = P(t, e, n, i, r, o, s, a, f), g.push(u.x), d.push(u.y)),
            p > 0 && 1 > p && (u = P(t, e, n, i, r, o, s, a, p), g.push(u.x), d.push(u.y)),
            h = o - 2 * i + e - (a - 2 * o + i),
            c = 2 * (i - e) - 2 * (o - i),
            l = e - i,
            f = ( - c + F.sqrt(c * c - 4 * h * l)) / 2 / h,
        ...
        function I(t, e) {
            ...
            return s || (i.curve = o(r)),
            s ? [r, s] : r
        }
        function B(t, e) {
            if (!e) return t;
            var n, i, r, o, s, a, u;
            for (t = I(t), r = 0, s = t.length; s > r; r++) for (u = t[r], o = 1, a = u.length; a > o; o += 2) n = e.x(u[o], u[o + 1]),
            i = e.y(u[o], u[o + 1]),
            u[o] = n,
            u[o + 1] = i;
            return t
        ...
        t.path.isBBoxIntersect = l,
        t.path.intersection = y,
        t.path.intersectionNumber = v,
    ...
    i.plugin(function(t) {
        ...
        r.push = function() {
            for (var t, e, n = 0,
            i = arguments.length; i > n; n++) t = arguments[n],
        ...
        r.forEach = function(t, e) {
            for (var n = 0,
            i = this.items.length; i > n; n++) if (t.call(e, this.items[n], n) === !1) return this;
            return this
        },
        r.remove = function() {
        ...
        r.attr = function(t) {
            for (var e = 0,
            n = this.items.length; n > e; e++) this.items[e].attr(t);
            return this
        },
        r.clear = function() {
    ...
    i.plugin(function(t, e) {
        ...
        function i(e, i, r) {
            ...
            for (var o, s, h, c, f = Math.max(e.length, i.length), p = [], d = [], g = 0; f > g; g++) {
                if (h = e[g] || n(i[g]), c = i[g] || n(h), h[0] != c[0] || "r" == h[0].toLowerCase() && (h[2] != c[2] || h[3] != c[3]) || "s" == h[0].toLowerCase() && (h[3] != c[3] || h[4] != c[4])) {
                    ...
                    i = t._.transform2matrix(i, r()),
                    p = [["m", e.a, e.b, e.c, e.d, e.e, e.f]],
                    d = [["m", i.a, i.b, i.c, i.d, i.e, i.f]];
                    break
                }
                for (p[g] = [], d[g] = [], o = 0, s = Math.max(h.length, c.length); s > o; o++) o in h && (p[g][o] = h[o]),
                o in c && (d[g][o] = c[o])
            }
            return {
                from: u(p),
        ...
        function u(t) {
            for (var e = [], n = 0, i = t.length; i > n; n++) for (var r = 1,
            o = t[n].length; o > r; r++) e.push(t[n][r]);
            return e
        }
        var h = {},
        c = /[a-z]+$/i,
        ...
        e.prototype.equal = function(e, n) {
            ...
            if ("colour" == h[e]) return f = t.color(d),
            p = t.color(n),
            {
            ...
            if ("points" == e) return f = l(d).split(","),
            p = l(n).split(","),
            {
                from: f,
                to: p,
    ...
    i.plugin(function(t, n, i, r) {
        ...
        s = "hasOwnProperty",
        a = ("createTouch" in r.doc), u = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "touchstart", "touchmove", "touchend", "touchcancel"], h = {
        ...
        g = function() {
            ...
            function(t, e, n, i) {
                ...
                o = function(r) {
                    var o = c("y"),
                    u = c("x");
                    if (a && h[s](e)) for (var l = 0,
                    p = r.targetTouches && r.targetTouches.length; p > l; l++) if (r.targetTouches[l].target == t || t.contains(r.targetTouches[l].target)) {
                        var g = r;
                        r = r.targetTouches[l],
                        r.originalEvent = g,
                        r.preventDefault = f,
                ...
                return e !== r && t.addEventListener(e, o, !1),
                t.addEventListener(r, o, !1),
                function() {
                    return e !== r && t.removeEventListener(e, o, !1),
            ...
            function(t, e, n, i) {
                var o = function(t) {
                    ...
                    s = t.clientX + o,
                    a = t.clientY + e;
                    return t.preventDefault = t.preventDefault || l,
            ...
            for (var i, r = n.clientX,
            o = n.clientY,
            s = c("y"), u = c("x"), h = m.length; h--;) {
                if (i = m[h], a) {
                ...
                r += u,
                o += s,
                e("snap.drag.move." + i.el.id, i.move_scope || i.el, r - i.el._drag.x, o - i.el._drag.y, r, o, n)
            }
        },
        v = function(n) {
            t.unmousemove(y).unmouseup(v);
            for (var i, r = m.length; r--;) i = m[r],
            i.el._drag = {},
            e("snap.drag.end." + i.el.id, i.end_scope || i.start_scope || i.move_scope || i.el, n);
            m = []
        },
        x = u.length; x--;) !
        function(e) {
            ...
            t["un" + e] = o["un" + e] = function(t) {
                for (var n = this.events || [], i = n.length; i--;) if (n[i].name == e && (n[i].f == t || !t)) return n[i].unbind(),
                n.splice(i, 1),
        ...
        o.drag = function(n, i, r, o, s, a) {
            function u(u, h, c) { (u.originalEvent || u).preventDefault(),
                this._drag.x = h,
                this._drag.y = c,
                this._drag.id = u.identifier,
                !m.length && t.mousemove(y).mouseup(v),
                m.push({
                    el: this,
                    move_scope: o,
                    start_scope: s,
                ...
                e("snap.drag.start." + this.id, s || o || this, h, c, u)
            }
            if (!arguments.length) {
                var h;
        ...
        o.undrag = function() {
            ...
            return ! b.length && t.unmousemove(y).unmouseup(v),
            this
        }
    }),
...
function(t, e, n) {
    ...
    s.prototype.check = function() {
        function t(t, r) {
            return e.options.debug && l && c.log("confirm", t, r),
            e.progress(t),
            n++,
            n === i && e.complete(),
            !0
...
function(t) {
    function e(t) {
        if (t) {
            ...
            for (var e, r = 0,
            o = n.length; o > r; r++) if (e = n[r] + t, "string" == typeof i[e]) return e
        }
    }
    ...
    function i(t) {
        function i(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var C = e(i.height);
                return C !== !1 && (r.height = C + (S ? 0 : y + w)),
                r.innerWidth = r.width - (m + b),
                r.innerHeight = r.height - (y + w),
...
function(t) {
    ...
    function i(i) {
        return i.bind(r, "DOMContentLoaded", n),
    ...
    o = [];
    e.isReady = !1,
    "function" == typeof define && define.amd ? (e.isReady = "function" == typeof requirejs, define("doc-ready/doc-ready", ["eventie/eventie"], i)) : t.docReady = i(t.eventie)
} (this),
function() {
    function t() {}
    function e(t, e) {
...
function(t) {
    ...
    function r(t, r, o) {
        ...
        a.prototype.layoutPosition = function() {
            ...
            e = this.layout.options,
            n = {};
            e.isOriginLeft ? (n.left = this.position.x + t.paddingLeft + "px", n.right = "") : (n.right = this.position.x + t.paddingRight + "px", n.left = ""),
            e.isOriginTop ? (n.top = this.position.y + t.paddingTop + "px", n.bottom = "") : (n.bottom = this.position.y + t.paddingBottom + "px", n.top = ""),
            this.css(n),
    ...
    s = o && o.getComputedStyle ?
    function(t) {
        return o.getComputedStyle(t, null)
    }: function(t) {
        return t.currentStyle
    };
    "function" == typeof define && define.amd ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property"], r) : (t.Outlayer = {},
...
function(t) {
    ...
    function s(n, s, l, p, d, g) {
        ...
        m.create = function(t, n) {
            ...
            return Object.create ? i.prototype = Object.create(m.prototype) : e(i.prototype, m.prototype),
...
function(t) {
    ...
    "function" == typeof define && define.amd ? define("packery/js/rect", e) : (t.Packery = t.Packery || {},
    t.Packery.Rect = e())
} (window),
function(t) {
    function e(t) {
...
function(t) {
    function e(t, e, n, i, r, o) {
        ...
        u.prototype._bindFitEvents = function(t) {
            function e() {
                i++,
                2 === i && n.emitEvent("fitComplete", [n, t])
            }
            var n = this,
            i = 0;
            t.on("layout",
        ...
        u.prototype.itemDragMove = function(t, e, n) {
            function i() {
                o.layout(),
                delete o.dragTimeout
            }
            var r = this.getItem(t);
            r && r.dragMove(e, n);
            var o = this;
            this.clearDragTimeout(),
            this.dragTimeout = setTimeout(i, 40)
        },
        ...
        u.prototype.itemDragEnd = function(e) {
            ...
            i.needsPositioning ? (i.on("layout", r), i.moveTo(i.placeRect.x, i.placeRect.y)) : i && i.copyPlaceRectPosition(),
            this.clearDragTimeout(),
        ...
        u.prototype._getDragEndLayoutComplete = function(e, n) {
            ...
            return function() {
                return r++,
                r !== o ? !0 : (n && (t.remove(n.element, "is-positioning-post-drag"), n.isPlacing = !1, n.copyPlaceRectPosition()), s.unstamp(e), s.sortItemsByPosition(), i && s.emitEvent("dragItemPositioned", [s, n]), !0)
            }
        },
...
var Sketch = function() {
    ...
    function u(t) {
        ...
        function s(t) {
            for (A = 0; A < tt.length; A++) O = tt[A],
            i(O) ? I[(t ? "add": "remove") + "EventListener"].call(I, O, L, !1) : e(O) ? L = O: I = O
        }
        function u() {
            R(_),
            _ = P(u),
            Y || (n(t.setup), Y = e(t.setup)),
            X || (n(t.resize), X = e(t.resize)),
            t.running && !V && (t.dt = (j = +new Date) - t.now, t.millis += t.dt, t.now = j, n(t.update), t.autoclear && J && t.clear(), n(t.draw)),
            V = ++V % t.interval
        }
        function h() {
            I = Z ? t.style: t.canvas,
            M = Z ? "px": "",
            $ = t.width,
            G = t.height,
            t.fullscreen && (G = t.height = v.innerHeight, $ = t.width = v.innerWidth),
            t.retina && J && Q && (I.style.height = G + "px", I.style.width = $ + "px", $ *= Q, G *= Q, t.scale(Q, Q)),
            I.height !== G && (I.height = G + M),
            I.width !== $ && (I.width = $ + M),
            Y && n(t.resize)
        }
        function c(t, e) {
            return z = e.getBoundingClientRect(),
            t.x = t.pageX - z.left - v.scrollX,
            t.y = t.pageY - z.top - v.scrollY,
            t
        }
        function l(e, n) {
            return c(e, t.element),
            n = n || {},
            n.ox = n.x || e.x,
            n.oy = n.y || e.y,
            n.x = e.x,
        ...
        function f(t) {
            if (t.preventDefault(), D = a(t), D.originalEvent = t, D.touches) for (U.length = D.touches.length, A = 0; A < D.touches.length; A++) U[A] = l(D.touches[A], U[A]);
            else U.length = 0,
            U[0] = l(D, K);
            return o(K, U[0], !0),
            D
        ...
        function C() { (t.running ? E: S)()
        }
        function k() {
            J && t.clearRect(0, 0, t.width, t.height)
        }
        function T() {
            B = t.element.parentNode,
            A = x.indexOf(t),
        ...
        var _, L, I, B, z, A, M, j, O, D, N, F, q, W, H, $, G, V = 0,
        U = [],
        X = !1,
        Y = !1,
    ...
    S = {
        ...
        create: function(t) {
            return t = o(t || {},
            b),
            t.globals && S.install(self),
            h = t.element = t.element || y.createElement(t.type === m ? "div": "canvas"),
            c = t.context = t.context ||
            function() {
                switch (t.type) {
                case d:
            ...
            (t.container || y.body).appendChild(h),
            S.augment(c, t)
        },
    ...
    E = ["ms", "moz", "webkit", "o"], C = self, k = 0, T = "AnimationFrame", _ = "request" + T, L = "cancel" + T, P = C[_], R = C[L], I = 0; I < E.length && !P; I++) P = C[E[I] + "Request" + T],
    R = C[E[I] + "Cancel" + T];
    return C[_] = P = P ||
    function(t) {
        var e = +new Date,
    ...
    var c = function(n) {
        ...
        if ($("[data-path-hover]").each(function(t, e) {
            ...
            if (d.length) {
                ...
                m = .75,
                y = 9.81,
                g = ["#FF4746", "#E8DA5E", "#92B55F", "#487D76"],
                b = function() {
                    function t(t, e, n) {
                        this.x = null != t ? t: 0,
                        this.y = null != e ? e: 0,
                        this.mass = null != n ? n: 1,
                        this.tail = [],
                ...
                Sketch.create({
                    ...
                    setup: function() {
                        var t, e, n, i, r, o;
                        for (o = [], t = r = 0; x >= r; t = r += 1) n = random(this.width),
                        i = random(this.height),
                        e = random(.5, 8),
                        o.push(this.particles.push(new b(n, i, e)));
                        return o
                    },
                    draw: function() {
                        var t, e, n, i, r, o, s, a, u, h, c, l, f, p, d, g, b, S, E, C, k;
                        for (this.lineCap = this.lineJoin = "round", k = [], h = d = 0; x >= d; h = d += 1) {
                            for (t = this.particles[h], random() < .08 && (t.charge = -t.charge), c = g = E = h + 1; x >= g; c = g += 1) e = this.particles[c],
                            r = e.x - t.x,
                            o = e.y - t.y,
                            i = sqrt(n = r * r + o * o + .1),
                            p = t.radius + e.radius,
                            i >= p && (l = 1 / i, a = r * l, u = o * l, s = min(v, y * t.mass * e.mass / n), t.fx += s * a * e.charge, t.fy += s * u * e.charge, e.fx += -s * a * t.charge, e.fy += -s * u * t.charge);
